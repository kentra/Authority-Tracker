        ...
        if gemini_client and tts_client:
            ...
            if log_data["amount_changed"] <= -10 or log_data["new_score"] <= 0:
                try:
                    ...
                    prompt = f"You are a stand up commedian with dark humor. Write a single, short sentence announcing current Authority change based on this context: {event_context} "
